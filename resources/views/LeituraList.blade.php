    ...
    <form action="{{ action('App\Http\Controllers\LeituraController@search') }}" method="post">
            ...
            <div class="row">
                ...
                <div class="col-6">
                    ...
                    <a class="btn btn-dark" href="{{ action('App\Http\Controllers\LeituraController@create') }}"><i
        ...
        <table class="table table-striped table-hover">
            <thead>
                <tr>
                    <th scope="col">ID</th>
                    <th scope="col">Nome do MAC</th>
                    <th scope="col">Hora Leitura</th>
